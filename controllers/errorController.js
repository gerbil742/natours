...
const sendErrorProd = (err, res) => {
  // Operational, trusted error: send message to client. like client entering data with missing field
  if (err.isOperational) {
    ...
    // Programming or other unknown error: dont want leak error details to client
  } else {
    // 1) Log error
